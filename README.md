...
Webview Bundle supports all the platforms that provide a webview — [Electron](https://www.electronjs.org/), [Tauri](https://tauri.app), Android, iOS, and [Deno Desktop](https://deno.com/desktop) (experimental) — and also ships with a bridge for communicating with the webview.

For more details, see the [documentation](https://wvb.dev/docs).
